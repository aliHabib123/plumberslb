...
smarty_core_load_plugins(array('plugins' => array(array('block', 'style_block', 'editors/image_uploader.tpl', 24, false),array('modifier', 'escapeurl', 'editors/image_uploader.tpl', 34, false),)), $this); ?>
...
_action" data-toggle="buttons-radio">
            <button type="button" value="Keep" class="active btn" data-toggle="button"><?php echo $this->_tpl_vars['Captions']->GetMessageString('KeepImage'); ?>
</button>
            <button type="button" value="Remove" class="btn" data-toggle="button"><?php echo $this->_tpl_vars['Captions']->GetMessageString('RemoveImage'); ?>
</button>
            <button id="<?php echo $this->_tpl_vars['Uploader']->GetName(); ?>
-replace-image-button" type="button" value="Replace" class="btn" data-toggle="button"><?php echo $this->_tpl_vars['Captions']->GetMessageString('ReplaceImage'); ?>
</button>
        </div>
...
_filename"
 ...
 <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_style_block($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
                onchange="$('#<?php echo $this->_tpl_vars['Uploader']->GetName(); ?>
